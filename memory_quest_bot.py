...
LOCATIONS = [
    {
        ...
        "wish": "«Кохання — це не дивитися одне на одного,\nа дивитися разом в одному напрямку.»",
        "task": (
    ...
    },
    {
        ...
        "wish": "«Довіра будується роками,\nруйнується хвилинами — і варта всього.»",
        "task": (
            "Пройдіть разом 20 кроків з закритими очима.\n\n"
    ...
    },
    {
        ...
        "task": (
            ...
            "Сьогодні ваш перший день як подружня пара.»\n\n"
...
def send_proposal(chat_id, user_id):
    ...
    bot.send_message(
        ...
        (
            f"🤝 *Пропозиція*\n\n"
            f"Зустрітись після весілля.\n"
            f"Поговорити про те, щоб створити\n"
            f"Memory Quest разом.\n\n"
            f"Так само як колись ви зустрілись\n"
            f"у цьому місці —\n"
            f"не знаючи що буде далі.\n\n"
            f"Без тиску. Без зобов'язань.\n"
